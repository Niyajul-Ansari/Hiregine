    ...
    return (
        <div className="flex flex-col items-center justify-center py-10 bg-gray-100 px-4">
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-10">
                {/* Vision Card */}
                <div
                    className="border border-red-400 rounded-lg p-8 text-center bg-white shadow-md cursor-pointer hover:shadow-lg transition-all relative"
                ...
                {/* Mission Card */}
                <div
                    className="border border-gray-300 rounded-lg p-8 text-center bg-white shadow-md cursor-pointer hover:shadow-lg transition-all"
